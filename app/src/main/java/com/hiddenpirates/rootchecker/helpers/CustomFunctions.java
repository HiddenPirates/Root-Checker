package com.hiddenpirates.rootchecker.helpers;
...
import com.hiddenpirates.rootchecker.BuildConfig;
import com.hiddenpirates.rootchecker.R;
                ...
                if (!latestVersion.equals("")) {
                    ...
                    if (lVersion > cVersion) {
                        ...
                        ((AppCompatActivity) context).runOnUiThread(() -> {
                            ...
                            builder.setIcon(context.getResources().getDrawable(R.drawable.ic_baseline_get_app_24));
